...
se le restara al saldo actual. Si la cuenta no tiene la cantidad de 
...
public class CuentaBancaria {
   ...
   private double saldoActual;
    ...
    public String toString() {
        return "CuentaBancaria{" + "Cuenta=" + numeroCuenta + ", DNI Cliente=" + dniCliente + ", Saldo Actual=" + saldoActual + '}';
    }
